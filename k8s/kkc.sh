...
export VPC=$(eval echo $(aws ec2 describe-vpcs --filters "Name=tag-key,Values=Environment" --filters "Name=tag-value,Values=$environment" --query 'Vpcs[].VpcId' --output text))
